...
:::{.columns}
::::{.column width="50%"}
- [Introduction to SQL]{.alert}: We will start by learning the fundamentals of SQL, focusing on SQLite
- [Setup]{.alert}: You will learn how to:
  - Load SQLite in Python with the [`sqlite3` library](https://docs.python.org/3/library/sqlite3.html)
  - Create a database
- [Querying]{.alert}: We will cover basic queries to interact with your database
- [Connecting with VSCode]{.alert}: You will also learn how to connect to your database using VS Code and the [SQLite Editor 3](https://marketplace.visualstudio.com/items?itemName=alexcvzz.vscode-sqlite) extension
:::
...
- Why? It is open-source, powerful, and widely used in the industry
- According to the 2024 [Stack Overflow survey](https://survey.stackoverflow.co/2024/technology/#1-databases), SQLite is one of the world's most popular databases
...
- The five core data types in SQLite: 
  ...
  - `NUMERIC`: Stores decimal numbers as 8-byte IEEE floating-point values
