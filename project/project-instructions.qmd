...
Students enrolled in QTM 531 - Computing II will have additional requirements for the project. The first requirement is to create a fully functional GitHub Pages site with clear navigation, the sections of your report, and a "Further Reading" section. The site should be visually appealing and easy to navigate. The second requirement is to include a section in your Quarto report that explains how you created the site, including the tools and technologies used. The third and final requirement is to perform some missing data imputation in SQL and/or Python.
...
The project will be due on December 09 at 11:59 PM. Please send the link to your repository on Canvas. You will submit the following items:
...
2. A Quarto report in PDF or HTML format. If you submit an HTML file, please make sure it is rendered on GitHub and all figures are displayed correctly. The report should include the following sections:
...
The report should be concise, but not too brief. You may aim for 3-5 pages, excluding the code.  You should focus on the main results and insights from the analysis. The report should be fully reproducible, meaning that anyone should be able to run the code and generate the same results as in the report.

In addition to the report, QTM 531 students have to submit another deliverable:

3. A functional website hosted on GitHub Pages. The website should include the following sections:
   - Introduction.
   - Data description.
   - Data analysis.
   - Results and discussion.
...
The first five sections should be the same as in the Quarto report. The "Further Reading" section should include links to the World Bank's website, the World Bank's API documentation, and other relevant resources you used in the project. All additional resources should also be related to your topic and consist of academic sources. You should include a navigation bar at the top of the page with links to each section. The website should be fully functional and accessible to anyone with the link.
...
Summary of main findings & 1                                            &   \\
\hline
\textbf{Data Description} &                                             & 4 \\
Clear introduction of the dataset and context & 1                       &   \\
Data merging steps       & 1                                            &   \\
Data cleaning and pre-processing & 1                                    &   \\
Summary of key variables (columns) & 1                                  &   \\
\hline
\textbf{Data Analysis}   &                                              & 3 \\
Interpretation of main results and trends & 2                           &   \\
Well-formatted tables and plots & 1                                     &   \\
\hline
\textbf{GitHub Management} &                                            & 3 \\
Consistent version control with meaningful commit messages & 1          &   \\
Effective use of branches and merges & 1                                &   \\
Clear README file outlining project structure and instructions & 1      &   \\
\hline
\textbf{MA-Specific Requirements} &                                     & 2 \\
Fully functional GitHub Pages site with clear navigation, introduction, analysis, conclusions, and further reading & 1  &   \\
Explanation of site creation process in Quarto report, including tools used & 1 &   \\
\hline
\textbf{Discussion}      &                                              & 2 \\
Clarity, conciseness, and relevance of discussion & 1                   &   \\
Reflection on findings and any limitations & 1                          &   \\
\hline
\textbf{Technical Requirements} &                                       & 2 \\
Report reproducibility using Quarto & 1                                 &   \\
Missing data imputation using SQL and/or Python & 1                     &   \\
\hline
\textbf{Total}           &                                              & \textbf{20} \\
\hline
\end{tabular}
